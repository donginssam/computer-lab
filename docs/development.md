...
| `pnpm check`        | `pnpm lint`과 `pnpm format:check`를 함께 실행                     |
...
| [.github/workflows/ci.yml](../.github/workflows/ci.yml)         | 모든 커밋의 검사·테스트·빌드·PWA 확인              |
| [.github/workflows/deploy.yml](../.github/workflows/deploy.yml) | CI 성공 후 Pages 배포                              |
